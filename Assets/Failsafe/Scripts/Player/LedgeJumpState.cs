...
public class LedgeJumpState : BehaviorState
{
    ...
    public LedgeJumpState(InputHandler inputHandler, CharacterController characterController, PlayerMovementParametrs movementParametrs, Transform headTransform)
    {
